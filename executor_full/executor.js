...
const pipeline = require("./lib/pipelineAuto")   // <-- toegevoegd
...
// =====================================================================
// HELPER: Map event → specifieke job
// =====================================================================
...
// =====================================================================
// EXECUTE (AO stuurt taak handmatig)
// =====================================================================
...
app.post("/webhook", async (req, res) => {
  ...
  try {
    // -----------------------------------------------------------
    // Autonomous pipeline bepalen (bijv. push → remap + repair)
    // -----------------------------------------------------------
    const chain = await pipeline.runPipeline(event, msg => console.log("[PIPE]", msg))
    ...
    for (const jobName of chain) {
      ...
      if (job) {
        ...
        console.log("Job niet gevonden:", jobName)
      }
    }
